      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent leading-tight">
            Hi, I'm Bernardo Yuji!
            <br />
            A Software Engineer student
          </h1>

          <p className="text-white-400 text-lg mb-8 max-w-lg mx-auto">
            I'm a Full-Stack developer who loves to code, build applications and resolve problems.
            <br />
            My goal is to build solutions that can really make a difference.
          </p>

          <div className="flex justify-center space-x-4">
            <Link
              to="/projects"
              className="bg-blue-600 text-white py-3 px-6 rounded font-medium transition
